...
/**
 * A no-operation implementation of UnitOfWorkEventListener.
 * Used when the unit of work event listener should not be active (e.g., in long transition mode).
 */
public class NoOpUnitOfWorkEventListener implements UnitOfWorkEventListener {
